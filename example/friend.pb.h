...
class GetFriendRequest final :
 ...
 public:
  ...
  void MergeFrom( const GetFriendRequest& from) {
    GetFriendRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
inline uint32_t GetFriendRequest::_internal_userid() const {
  return _impl_.userid_;
}
inline uint32_t GetFriendRequest::userid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendRequest.userid)
  return _internal_userid();
}
inline void GetFriendRequest::_internal_set_userid(uint32_t value) {
  
  _impl_.userid_ = value;
}
inline void GetFriendRequest::set_userid(uint32_t value) {
